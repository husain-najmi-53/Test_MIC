...
class EPCForm1YOD3TP extends StatefulWidget {
  const EPCForm1YOD3TP({
    super.key,
  });

  @override
  State<EPCForm1YOD3TP> createState() => _EPCForm1YOD3TPState();
}

class _EPCForm1YOD3TPState extends State<EPCForm1YOD3TP> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      // TP Section
      double cngLpgRate = 3*60;   // change to actual IRDA rate
      ...
      InsuranceResultData resultData = InsuranceResultData(
        vehicleType: "Electric Four Wheeler",
        fieldData: resultMap,
        ...
        title: const FittedBox(
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(width: 8),
              Text(
                'Electric Private Car 1Yr OD 3Yr TP',
