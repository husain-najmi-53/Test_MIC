...
class EPCForm1YOD extends StatefulWidget {
  const EPCForm1YOD({
    super.key,
  });

  @override
  State<EPCForm1YOD> createState() => _EPCForm1YODState();
}

class _EPCForm1YODState extends State<EPCForm1YOD> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      double kwCapacity =
          double.tryParse(_controllers['kwCapacity']!.text) ?? 0;
      double discountOnOd =
      ...
      double zeroDepreciation = double.tryParse(_controllers['zeroDepreciation']!.text) ?? 0.0;
      double RSAaddons =
      ...
      double totalBasicPremium =
          basicOdAfterDiscount + accessoriesValue ;
      ...
      InsuranceResultData resultData = InsuranceResultData(
        vehicleType: "Electric Four Wheeler OD",
        fieldData: resultMap,
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              /*  _buildDropdownField(
                ...
                // _buildTextField('paUnnamedPassenger', 'PA to Unnamed Passenger (₹)', true, "Enter Value "),
                _buildTextField(
