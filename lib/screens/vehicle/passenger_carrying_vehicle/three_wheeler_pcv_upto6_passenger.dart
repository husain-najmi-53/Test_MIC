...
class ThreeWheelerPCV_upto6Passenger extends StatefulWidget {
  const ThreeWheelerPCV_upto6Passenger({super.key});

  @override
  State<ThreeWheelerPCV_upto6Passenger> createState() =>
      _ThreeWheelerPCV_upto6PassengerState();
}

class _ThreeWheelerPCV_upto6PassengerState
    extends State<ThreeWheelerPCV_upto6Passenger> {
  ...
  //   _controllers['Idv']!.text = currentIdv.toStringAsFixed(2);
  // }
  ...
  void _updateCurrentIdv() {
   ...
   void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      // OD Premium calculations based on your quotation's logic
