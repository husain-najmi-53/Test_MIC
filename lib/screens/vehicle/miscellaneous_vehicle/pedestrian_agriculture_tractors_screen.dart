  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      double llLEmployeeOther =
          double.tryParse(_selectedLlEmployeePaidDriver ?? "0") ?? 0.0;
            ...
            child: Column(
              children: [
                ...
                _buildDropdownField(
                    ...
                    _llEmployeePaidDriverOptions,
                    _selectedLlEmployeePaidDriver,
                    (val) =>
                        setState(() => _selectedLlEmployeePaidDriver = val)),
                _buildTextField(
                    'll2Passenger',
