...
class ElectricTwoWheeler1YODFormScreen extends StatefulWidget {
  const ElectricTwoWheeler1YODFormScreen({super.key});

  @override
  State<ElectricTwoWheeler1YODFormScreen> createState() =>
      _ElectricTwoWheeler1YODFormScreenState();
}

class _ElectricTwoWheeler1YODFormScreenState
    extends State<ElectricTwoWheeler1YODFormScreen> {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                _buildTextField('kwCapacity', 'KW (Kilowatt Capacity)',
                    'Enter kW Capacity'),
