...
class ElectricTwoWheeler1YearOD1YearTPFormScreen extends StatefulWidget {
  const ElectricTwoWheeler1YearOD1YearTPFormScreen({super.key});

  @override
  State<ElectricTwoWheeler1YearOD1YearTPFormScreen> createState() =>
      _ElectricTwoWheeler1YearOD1YearTPFormScreenState();
}

class _ElectricTwoWheeler1YearOD1YearTPFormScreenState
    extends State<ElectricTwoWheeler1YearOD1YearTPFormScreen> {
